...
class LeaveController extends AbstractController
{
    ...
    public function index(LeaveRepository $leaveRepository, EmployeeRepository $er): Response
    {
    ...
    #[Route('return/{id}', name: 'app_leave_return', methods: ['GET'])]
    public function returnFromLeaves(Request $request, Leave $leave, EntityManagerInterface $entityManager, LeaveRepository $lr): Response
    {
        $lr->returnFromLeaves($leave->getId());
